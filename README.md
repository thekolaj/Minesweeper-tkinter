...
Created for CS50’s Introduction to Computer Science as a final project.
#### Operations:
...
stretch it.
- Get familiar with python classes. Write the whole game object-oriented and use
`@classmethod` and `@staticmethod` somewhere in my code.
...
#### Python classes are easy:
While some of `@classmethod`s and having `Tk()` as class attribute might be unnecessary,
I am very happy with how it turned out. I got a deeper understanding of classes with this 
project. 

Of particular note is the use of class attribute for cell controls and how it lets
you disable multiple cells with ease.
...
implement in a resizable interface. 
Not to mention they are more in the spirit of the course, considering that
the whole final lecture of CS50 is dedicated to them. The only drawback is that there is
...
There are still things I feel like changing and tweaking: 
- How cells scale, maybe try to make them keep aspect ratio and stay square while feeling
in the window on the edges with dead space.
- How text resizing is handled. Text resizing on Reset is less than optimal.
- Performance is lacking in big games. Perhaps abandon buttons as cell basis and just use 
frames or labels.

However, I feel like I got all the knowledge I was looking for out of this project, and 
it is time to declare it finished. 

**I'm proud of what I have achieved with this project and wholeheartedly recommend
others to try coding their own version of minesweeper when learning tkinter.**
